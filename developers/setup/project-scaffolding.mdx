...
Autheo Chain is EVM-compatible — Mainnet chain ID `2127`, Testnet chain ID `21270` — which means any Hardhat, Foundry, or ethers.js project can target it with minimal configuration. This page shows the minimum setup for each major toolchain.
...
<Steps>
  ...
  <Step title="Configure foundry.toml">
    ...
    autheo_testnet = "https://rpc.testnet.autheo.com"
    ```
  </Step>
  <Step title="Deploy">
    ```bash
