...
<Note>
This applies to a node you run yourself. **Public WebSocket access is not yet available** on Mainnet or Testnet (see [Network endpoints](/getting-started/network/endpoints)).
</Note>
