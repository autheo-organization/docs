...
The official image is published at `example.com/autheo-blockchain/autheod`.

### 3.1 Pull the Image

```bash
docker pull example.com/autheo-blockchain/autheod:latest
```
...
docker run --rm \
  ...
  example.com/autheo-blockchain/autheod:latest \
