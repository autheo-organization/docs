...
<CardGroup cols={2}>
  ...
  <Card title="Consensus mechanism (Proof of Autheo)" icon="shield-check">
    Proof of Autheo hybrid PoA/PoS consensus design and validator requirements
  </Card>
...
For THEO token economics, see the dedicated [Tokenomics paper v1.3](/token/tokenomics-paper-v1-2) in the Token section.
