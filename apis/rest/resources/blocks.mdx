...
```
curl -X 'GET' \
  'https://evm-explorer.autheo.com/api/v2/blocks' \
...
```
curl -X 'GET' \
  'https://evm-explorer.autheo.com/api/v2/blocks/0xf569ec751152b2f814001fc730f7797aa155e4bc3ba9cb6ba24bc2c8c9468c1a' \
  -H 'accept: application/json'
```
...
```
curl -X 'GET' \
  'https://evm-explorer.autheo.com/api/v2/blocks/0x5d90a9da2b8da402b11bc92c8011ec8a62a2d59da5c7ac4ae0f73ec51bb73368/transactions' \
  -H 'accept: application/json'
```
...
```
curl -X 'GET' \
  'https://evm-explorer.autheo.com/api/v2/blocks/0x5d90a9da2b8da402b11bc92c8011ec8a62a2d59da5c7ac4ae0f73ec51bb73368/withdrawals' \
  -H 'accept: application/json'
```
