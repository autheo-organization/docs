...
<Note>
Examples below use `https://rpc1.autheo.com` (mainnet). For testnet, substitute `https://rpc.testnet.autheo.com`. See [Network endpoints](/getting-started/network/endpoints) for the full list.
</Note>
