...
| Testnet RPC (HTTP) | `https://rpc.testnet.autheo.com` |
| EVM explorer (mainnet) | `https://evm-explorer.autheo.com/` |
| Cosmos explorer (mainnet) | `https://cosmos.autheo.com` |
| EVM explorer (testnet) | `https://evm-explorer.testnet.autheo.com/` |
| Cosmos explorer (testnet) | `https://cosmos.testnet.autheo.com/` |
...
|---|---|---|
| Tokenomics paper v1.3 | THEO token design, emissions, and productive deflation | [Read](/token/tokenomics-paper-v1-2) |
