...
<Steps>
  ...
  <Step title="Verify prerequisites">
    ...
    Full guide → [Node setup](/nodes/testnet/node-setup)
  </Step>
  <Step title="Install autheod">
    ...
    Full guide → [Installation](/nodes/testnet/installation)
  </Step>
  <Step title="Bind the license on-chain">
    ...
    Full guide → [License setup](/nodes/testnet/license-setup)
  </Step>
  <Step title="Configure and start the node">
    ...
    Full guide → [Production deployment](/nodes/testnet/configuration)
