...
For automated upgrade management, consider running the node under [Cosmovisor](https://github.com/cosmos/cosmos-sdk/blob/main/tools/cosmovisor/README.md). Cosmovisor monitors for on-chain upgrade proposals and automatically swaps the binary at the target height.
