---
title: "Prerequisites"
description: "Hardware, software, wallet, license, and network requirements to complete before setting up an Autheo Chain validator."
...
Before continuing with node setup:

- Configure your wallet for the Autheo network as required by the license and validator setup flow.
- Make sure your Sovereign license has been purchased and transferred from Arbitrum to your Autheo Chain address.
- Keep sufficient THEO (`aauth`) in the operator account for validator transactions and network fees.
- Keep the wallet credentials and validator keys securely backed up.
...
<Warning>
  ...
  Only a **Sovereign** license can be used to create and operate a validator. Prime and Core licenses are for delegation and are not valid for `MsgCreateValidator`.
</Warning>
...
- [ ] Sovereign NFT license acquired, bridged to Autheo Chain, and in `BOUND` status
- [ ] Operator account funded with sufficient `aauth` for validator transactions and network fees
