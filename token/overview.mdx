...
| Chain ID (Testnet) | `autheo_21270-1` (Cosmos) / `21270` (EVM) |
...
<CardGroup cols={2}>
  ...
  <Card title="Buying and trading THEO" href="/token/buying-and-trading-theo" icon="arrow-right-arrow-left">
    How to buy, sell, and trade THEO on Hydrex
  </Card>
