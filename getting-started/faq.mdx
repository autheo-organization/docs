...
Yes — full Ethermint EVM with JSON-RPC on port 8545 (HTTP) and 8546 (WebSocket). MetaMask, ethers.js, Hardhat, and Foundry all work with Chain ID `2127` (mainnet) or `21270` (testnet).
