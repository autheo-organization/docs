...
| Card | Description |
| :-- | :-- |
| Total Rewards Earned | Cumulative THEO earned from staking and validator-related rewards shown by the Validator Portal. Click ↻ to refresh. |
| THEO Wallet Balance | Your current THEO token balance. Click ↻ to refresh. |

> **Reward types:** Staking rewards and NFT/license rewards are separate reward streams. The dashboard's **Total Rewards Earned** value should be interpreted according to the reward types currently included by the portal.

![Validator Portal dashboard showing rewards and wallet balance cards](/images/vp-dashboard.png)
...
![License status panel showing Sovereign, Core, and Prime counts](/images/vp-license-status.png)
...
![Node Status table showing validator nodes and their current status](/images/vp-node-status.png)
