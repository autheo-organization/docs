...
<Steps>
  ...
  <Step title="Deploy and complete checkout">
    ...
    ![Node deployment configuration — step 1](/images/vp-deploy-checkout-1.png)

    ![Node deployment configuration — step 2](/images/vp-deploy-checkout-2.png)

    ![Node deployment configuration — step 3](/images/vp-deploy-checkout-3.png)

    ![Stripe checkout for node subscription](/images/vp-deploy-checkout-4.png)

    ![Node provisioning status after checkout](/images/vp-deploy-checkout-5.png)
  </Step>
