...
Once your NFT is visible in MetaMask, the next step is to bridge it from Arbitrum to your Autheo Chain address. See the [Autheo Bridge](/web-apps/bridge/making-a-transfer) guide, or the full [license setup walkthrough](/nodes/testnet/license-setup) for the complete on-chain binding process.
