...
<Steps>
  ...
  <Step title="Accept the terms and conditions">
    ...
    ![Terms and conditions acceptance screen](/images/node-sale-accept-terms.png)
  </Step>
  <Step title="Connect your wallet">
    ...
    ![Connect wallet step 1 — wallet selector modal](/images/node-sale-connect-wallet-1.png)

    ![Connect wallet step 2 — wallet extension approval](/images/node-sale-connect-wallet-2.png)

    ![Connect wallet step 3 — SIWE signature request](/images/node-sale-connect-wallet-3.png)
  </Step>
</Steps>
