...
<Steps>
  <Step title="Select the source chain">
    ...
    ![Chain selection modal](/images/bridge-select-chain.png)
  </Step>
  ...
  <Step title="Choose a token">
    ...
    ![Token selection modal](/images/bridge-choose-token.png)
  </Step>
  ...
  <Step title="Enter the recipient address">
    ...
    ![Recipient address field](/images/bridge-recipient-address.png)
  </Step>
  <Step title="Review and confirm">
    ...
    ![Review and confirm transfer details](/images/bridge-review-confirm.png)
  </Step>
  <Step title="Sign the transactions">
    ...
    ![Sign transaction — step 1](/images/bridge-sign-tx-1.png)

    ![Sign transaction — step 2](/images/bridge-sign-tx-2.png)

    ![Sign transaction — step 3](/images/bridge-sign-tx-3.png)

    ![Sign transaction — step 4, transfer confirmed](/images/bridge-sign-tx-4.png)
  ...
  <Step title="Track delivery">
    ...
    ![Transfer delivery tracking — in progress](/images/bridge-track-delivery-1.png)

    ![Transfer delivery tracking — completed](/images/bridge-track-delivery-2.png)
  </Step>
</Steps>
